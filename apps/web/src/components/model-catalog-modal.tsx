      ...
      >
            ...
            <>
                ...
                <div className="flex items-center gap-3 border-b border-border bg-danger/5 px-6 py-3">
                  ...
                  {onRetry && (
                    <button
                      type="button"
                      onClick={onRetry}
                      className="shrink-0 rounded-[14px] border border-danger/30 px-3 py-1.5 text-xs font-semibold text-danger transition hover:bg-danger/10"
                    >
                      Tentar novamente
                    </button>
                  )}
              ...
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  ...
                  {filtered.length === 0 && (
                    <tr>
                      <td colSpan={10} className="px-6 py-12 text-center text-mute">
        ...
        <div className="flex items-center justify-between border-t border-border px-6 py-4">
          <p className="text-sm text-mute">
            {filtered.length} modelos • {selectedIds.size} no catálogo pessoal
          </p>
          <button
            type="button"
            onClick={onClose}
