...
export const MODEL_REGISTRY: ModelSpec[] = [
  ...
  { id: 'o3-mini', provider: 'openai', name: 'o3-mini', description: 'Compact reasoning model — fast and efficient', contextTokens: 200_000, pricing: { input: 1.1, output: 4.4 }, ratings: { extraction: 82, synthesis: 83, reasoning: 91, writing: 80 } },
  { id: 'o4-mini', provider: 'openai', name: 'o4-mini', description: 'Latest cost-effective reasoning model', contextTokens: 200_000, pricing: { input: 1.1, output: 4.4 }, ratings: { extraction: 84, synthesis: 85, reasoning: 93, writing: 82 } },
  ...
  { id: 'gpt-4-turbo', provider: 'openai', name: 'GPT-4 Turbo', description: 'Previous generation flagship with vision', contextTokens: 128_000, pricing: { input: 10.0, output: 30.0 }, ratings: { extraction: 88, synthesis: 89, reasoning: 90, writing: 90 } },
  { id: 'gpt-3.5-turbo', provider: 'openai', name: 'GPT-3.5 Turbo', description: 'Legacy fast model — lowest cost for simple tasks', contextTokens: 16_385, pricing: { input: 0.5, output: 1.5 }, ratings: { extraction: 72, synthesis: 70, reasoning: 65, writing: 72 } },

  // ── Anthropic ──
  { id: 'claude-opus-4', provider: 'anthropic', name: 'Claude Opus 4', description: 'Most capable Anthropic model — superior reasoning and analysis', contextTokens: 200_000, pricing: { input: 15.0, output: 75.0 }, ratings: { extraction: 96, synthesis: 97, reasoning: 98, writing: 97 } },
  ...
  { id: 'claude-3.5-sonnet', provider: 'anthropic', name: 'Claude 3.5 Sonnet', description: 'Previous generation Sonnet — excellent writing quality', contextTokens: 200_000, pricing: { input: 3.0, output: 15.0 }, ratings: { extraction: 92, synthesis: 91, reasoning: 91, writing: 94 } },
  ...
  { id: 'claude-3-haiku', provider: 'anthropic', name: 'Claude 3 Haiku', description: 'Legacy compact model — near-instant responses', contextTokens: 200_000, pricing: { input: 0.25, output: 1.25 }, ratings: { extraction: 75, synthesis: 73, reasoning: 70, writing: 74 } },
  ...
  { id: 'gemini-1.5-pro', provider: 'google', name: 'Gemini 1.5 Pro', description: 'Previous gen with 2M context for very long documents', contextTokens: 2_097_152, pricing: { input: 1.25, output: 5.0 }, ratings: { extraction: 88, synthesis: 87, reasoning: 88, writing: 86 } },
  { id: 'gemini-1.5-flash', provider: 'google', name: 'Gemini 1.5 Flash', description: 'Previous gen fast model with long context', contextTokens: 1_048_576, pricing: { input: 0.075, output: 0.3 }, ratings: { extraction: 78, synthesis: 76, reasoning: 75, writing: 74 } },
  ...
  { id: 'llama-3.1-70b-versatile', provider: 'groq', name: 'Llama 3.1 70B', description: 'Previous gen 70B — strong general performance', contextTokens: 128_000, pricing: { input: 0.59, output: 0.79 }, ratings: { extraction: 80, synthesis: 79, reasoning: 80, writing: 78 } },
  ...
  { id: 'llama-3.2-3b-preview', provider: 'groq', name: 'Llama 3.2 3B', description: 'Compact model — fastest latency for basic tasks', contextTokens: 128_000, pricing: { input: 0.06, output: 0.06 }, ratings: { extraction: 62, synthesis: 58, reasoning: 55, writing: 58 } },
  ...
  { id: 'qwen-qwq-32b', provider: 'groq', name: 'Qwen QwQ 32B', description: 'Alibaba reasoning model with strong multilingual', contextTokens: 128_000, pricing: { input: 0.29, output: 0.39 }, ratings: { extraction: 78, synthesis: 76, reasoning: 85, writing: 75 } },
  ...
  { id: 'llama3.1:latest', provider: 'ollama', name: 'Llama 3.1 8B (local)', description: 'Run Llama 3.1 8B locally — solid general performance', contextTokens: 128_000, pricing: { input: 0, output: 0 }, ratings: { extraction: 68, synthesis: 65, reasoning: 62, writing: 64 } },
  { id: 'llama3.1:70b', provider: 'ollama', name: 'Llama 3.1 70B (local)', description: 'Large local model — needs 40GB+ VRAM', contextTokens: 128_000, pricing: { input: 0, output: 0 }, ratings: { extraction: 80, synthesis: 79, reasoning: 80, writing: 78 } },
  ...
  { id: 'mixtral:latest', provider: 'ollama', name: 'Mixtral 8x7B (local)', description: 'MoE model — strong multilingual, needs 26GB+', contextTokens: 32_768, pricing: { input: 0, output: 0 }, ratings: { extraction: 75, synthesis: 74, reasoning: 73, writing: 74 } },
  ...
  { id: 'gemma2:latest', provider: 'ollama', name: 'Gemma 2 9B (local)', description: 'Google Gemma 2 — efficient and accurate', contextTokens: 8_192, pricing: { input: 0, output: 0 }, ratings: { extraction: 70, synthesis: 68, reasoning: 66, writing: 68 } },
  ...
  { id: 'deepseek-r1:latest', provider: 'ollama', name: 'DeepSeek R1 (local)', description: 'Reasoning-focused model — strong at analysis', contextTokens: 128_000, pricing: { input: 0, output: 0 }, ratings: { extraction: 78, synthesis: 77, reasoning: 86, writing: 75 } },
  { id: 'nomic-embed-text:latest', provider: 'ollama', name: 'Nomic Embed (local)', description: 'Text embedding model for vector search', contextTokens: 8_192, pricing: { input: 0, output: 0 }, ratings: { extraction: 60, synthesis: 40, reasoning: 30, writing: 30 } },
  ...
  { id: 'anthropic/claude-opus-4', provider: 'openrouter', name: 'Claude Opus 4 (OR)', description: 'Claude Opus 4 via OpenRouter — most powerful', contextTokens: 200_000, pricing: { input: 15.0, output: 75.0 }, ratings: { extraction: 96, synthesis: 97, reasoning: 98, writing: 97 } },
  ...
  { id: 'openai/o3', provider: 'openrouter', name: 'o3 (OR)', description: 'OpenAI o3 reasoning model via OpenRouter', contextTokens: 200_000, pricing: { input: 10.0, output: 40.0 }, ratings: { extraction: 90, synthesis: 92, reasoning: 99, writing: 88 } },
  ...
  { id: 'deepseek/deepseek-chat', provider: 'openrouter', name: 'DeepSeek V3 (OR)', description: 'DeepSeek V3 chat model — excellent value', contextTokens: 128_000, pricing: { input: 0.27, output: 1.1 }, ratings: { extraction: 82, synthesis: 81, reasoning: 84, writing: 80 } },
  ...
  { id: 'mistralai/mistral-small-3.2', provider: 'openrouter', name: 'Mistral Small 3.2 (OR)', description: 'Mistral Small — fast and efficient', contextTokens: 128_000, pricing: { input: 0.1, output: 0.3 }, ratings: { extraction: 74, synthesis: 72, reasoning: 70, writing: 72 } },
  ...
  { id: 'cohere/command-r-plus', provider: 'openrouter', name: 'Command R+ (OR)', description: 'Cohere Command R+ — strong for RAG and retrieval', contextTokens: 128_000, pricing: { input: 2.5, output: 10.0 }, ratings: { extraction: 86, synthesis: 84, reasoning: 82, writing: 83 } },
  { id: 'x-ai/grok-3', provider: 'openrouter', name: 'Grok 3 (OR)', description: 'xAI Grok 3 — competitive flagship model', contextTokens: 131_072, pricing: { input: 3.0, output: 15.0 }, ratings: { extraction: 88, synthesis: 87, reasoning: 90, writing: 86 } },
];
